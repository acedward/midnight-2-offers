...
|---|---|---|
| dApp source | `effectstream/shielded-night` @ `bc483aeb61e1cc9c789be83ca2d1f43ec24ec979` (branch **`ledger-v9`**) | `SHIELDED_NIGHT_REF` — Dockerfile ARG default, `.env.example`, `compose/shielded-night.yml`, baked into both runtime images as `/.shielded-night-commit` |
...
`ledger-v9` head at `bc483aeb…` merged in shielded-night `main`'s own PR #12, which regenerated
