...
| **Passport accounts** — account contract, ERC20 vault, client | [`acedward/passport`](https://github.com/acedward/passport) `00034-passport-evm-account-zswap`; the whole call tree compiled in-image with the kernel's compactc 0.34.0 | [`34c71a48ee3e`](https://github.com/acedward/passport/commit/34c71a48ee3ef475479a0582c50cda5b12feec80) | `.env.example` · `compose/aa.yml` · `images/aa-contracts/Dockerfile` · `scripts/verify-source-pins.sh` |
